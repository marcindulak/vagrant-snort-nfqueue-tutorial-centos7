...
```
    ...
    'vagrant-snort-nfqueue-tutorial-centos7/ipynb/README.md' -> './ipynb/README.md'
    ...
    'vagrant-snort-nfqueue-tutorial-centos7/ipynb/vagrant-snort-nfqueue-tutorial-centos7.md' -> './ipynb/vagrant-snort-nfqueue-tutorial-centos7.md'
    ...
    'vagrant-snort-nfqueue-tutorial-centos7/spec/daq/daq.spec' -> './spec/daq/daq.spec'
    'vagrant-snort-nfqueue-tutorial-centos7/spec/snort-extra/snort-extra.spec' -> './spec/snort-extra/snort-extra.spec'
    'vagrant-snort-nfqueue-tutorial-centos7/spec/snort/snort.service' -> './spec/snort/snort.service'
    'vagrant-snort-nfqueue-tutorial-centos7/spec/snort/snort.spec' -> './spec/snort/snort.spec'
...
```
    ...
    ==> attacker0: Setting the name of the VM: jupyter_attacker0_1493823063769_39738
    ==> attacker0: Fixed port collision for 22 => 2222. Now on port 2201.
    ...
    ==> attacker0: Forwarding ports...
        attacker0: 22 (guest) => 2201 (host) (adapter 1)
    ...
    ==> attacker0: Waiting for machine to boot. This may take a few minutes...
        attacker0: SSH address: 127.0.0.1:2201
    ...
    ==> attacker0: ================================================================================
    ==> attacker0: Installing:
    ==> attacker0:  ntp                 x86_64     4.2.6p5-25.el7.centos.2       updates     547 k
    ==> attacker0: Installing for dependencies:
    ==> attacker0:  autogen-libopts     x86_64     5.18-5.el7                    base         66 k
    ==> attacker0:  ntpdate             x86_64     4.2.6p5-25.el7.centos.2       updates      86 k
    ==> attacker0: 
    ==> attacker0: Transaction Summary
    ==> attacker0: ================================================================================
    ...
    ==> attacker0: Public key for ntpdate-4.2.6p5-25.el7.centos.2.x86_64.rpm is not installed
    ==> attacker0: warning: /var/cache/yum/x86_64/7/updates/packages/ntpdate-4.2.6p5-25.el7.centos.2.x86_64.rpm: Header V3 RSA/SHA256 Signature, key ID f4a80eb5: NOKEY
    ...
    ==> attacker0: 
    ==> attacker0: Installed:
    ==> attacker0:   ntp.x86_64 0:4.2.6p5-25.el7.centos.2                                          
    ==> attacker0: 
    ==> attacker0: Dependency Installed:
    ==> attacker0:   autogen-libopts.x86_64 0:5.18-5.el7  ntpdate.x86_64 0:4.2.6p5-25.el7.centos.2 
    ==> attacker0: Running provisioner: shell...
        attacker0: Running: inline script
    ...
    ==> monitor0: Setting the name of the VM: jupyter_monitor0_1493823171794_75741
    ==> monitor0: Fixed port collision for 22 => 2222. Now on port 2203.
    ...
    ==> monitor0: ================================================================================
    ==> monitor0: Installing:
    ==> monitor0:  ntp                 x86_64     4.2.6p5-25.el7.centos.2       updates     547 k
    ==> monitor0: Installing for dependencies:
    ==> monitor0:  autogen-libopts     x86_64     5.18-5.el7                    base         66 k
    ==> monitor0:  ntpdate             x86_64     4.2.6p5-25.el7.centos.2       updates      86 k
    ==> monitor0: 
    ==> monitor0: Transaction Summary
    ==> monitor0: ================================================================================
    ...
    ==> monitor0: 
    ==> monitor0: Installed:
    ==> monitor0:   ntp.x86_64 0:4.2.6p5-25.el7.centos.2                                          
    ==> monitor0: 
    ==> monitor0: Dependency Installed:
    ==> monitor0:   autogen-libopts.x86_64 0:5.18-5.el7  ntpdate.x86_64 0:4.2.6p5-25.el7.centos.2 
    ==> monitor0: Running provisioner: shell...
        monitor0: Running: inline script
    ...
    ==> snort0: Setting the name of the VM: jupyter_snort0_1493823276880_94113
    ==> snort0: Fixed port collision for 22 => 2222. Now on port 2204.
    ...
    ==> snort0: Public key for libxml2-python-2.9.1-6.el7_2.3.x86_64.rpm is not installed
    ==> snort0: warning: /var/cache/yum/x86_64/7/base/packages/libxml2-python-2.9.1-6.el7_2.3.x86_64.rpm: Header V3 RSA/SHA256 Signature, key ID f4a80eb5: NOKEY
    ...
    ==> snort0: ================================================================================
    ==> snort0: Installing:
    ==> snort0:  ntp                 x86_64     4.2.6p5-25.el7.centos.2       updates     547 k
    ==> snort0: Installing for dependencies:
    ==> snort0:  autogen-libopts     x86_64     5.18-5.el7                    base         66 k
    ==> snort0:  ntpdate             x86_64     4.2.6p5-25.el7.centos.2       updates      86 k
    ==> snort0: 
    ==> snort0: Transaction Summary
    ==> snort0: ================================================================================
    ...
    ==> snort0: 
    ==> snort0: Installed:
    ==> snort0:   ntp.x86_64 0:4.2.6p5-25.el7.centos.2                                          
    ==> snort0: 
    ==> snort0: Dependency Installed:
    ==> snort0:   autogen-libopts.x86_64 0:5.18-5.el7  ntpdate.x86_64 0:4.2.6p5-25.el7.centos.2 
    ==> snort0: Running provisioner: shell...
        snort0: Running: inline script
...
```
    ...
    ================================================================================
    Installing:
     prometheus    x86_64    1.6.1-1.el7.centos     prometheus-rpm_release     10 M
    ...
    Installed:
      prometheus.x86_64 0:1.6.1-1.el7.centos                                        
...
```
    ...
    ================================================================================
    Installing:
     snort            x86_64 3.0.0-0.232.a4.el7.centos copr-marcindulak-snort 1.8 M
     snort-extra      x86_64 1.0.0-0.232.a4.el7.centos copr-marcindulak-snort  75 k
    ...
    Installed:
      snort.x86_64 0:3.0.0-0.232.a4.el7.centos                                      
      snort-extra.x86_64 0:1.0.0-0.232.a4.el7.centos                                
...
```
    ...
    # Generated by iptables-save v1.4.21 on Wed May  3 14:56:57 2017
    *filter
    :INPUT ACCEPT [51:7234]
    :FORWARD ACCEPT [0:0]
    :OUTPUT ACCEPT [37:6114]
    -A INPUT -i enp0s8 -j NFQUEUE --queue-num 0 --queue-bypass
    -A OUTPUT -o enp0s8 -j NFQUEUE --queue-num 0 --queue-bypass
    COMMIT
    # Completed on Wed May  3 14:56:57 2017
...
```
    ...
    ● snort@enp0s8.service - Snort on 'enp0s8'
       ...
       Active: active (running) since Wed 2017-05-03 14:56:52 UTC; 7s ago
      Process: 5653 ExecStartPre=/bin/sh -c /usr/sbin/iptables -t filter -C OUTPUT -o %I -j NFQUEUE --queue-num 0 --queue-bypass || /usr/sbin/iptables -t filter -I OUTPUT -o %I -j NFQUEUE --queue-num 0 --queue-bypass (code=exited, status=0/SUCCESS)
      Process: 5643 ExecStartPre=/bin/sh -c /usr/sbin/iptables -t filter -C INPUT -i %I -j NFQUEUE --queue-num 0 --queue-bypass || /usr/sbin/iptables -t filter -I INPUT -i %I -j NFQUEUE --queue-num 0 --queue-bypass (code=exited, status=0/SUCCESS)
     Main PID: 5658 (snort)
       CGroup: /system.slice/system-snort.slice/snort@enp0s8.service
               └─5658 /usr/sbin/snort -d -Q --daq-dir /usr/lib64/daq --daq nfq -l /var/log/snort -c /etc/snort/snort.lua -A unified2 -v --plugin-path /usr/lib64/snort_extra/codecs
    
    May 03 14:56:52 snort0 snort[5658]: MaxClientBytes: 19600
    May 03 14:56:52 snort0 snort[5658]: Portscan Detection Config:
    May 03 14:56:52 snort0 snort[5658]: Detect Protocols:  TCP UDP ICMP IP
    May 03 14:56:52 snort0 snort[5658]: Detect Scan Type:  portscan portsweep decoy_portscan distributed_portscan
    May 03 14:56:52 snort0 snort[5658]: Sensitivity Level: Medium
    May 03 14:56:52 snort0 snort[5658]: Memcap (in bytes): 1048576
    May 03 14:56:52 snort0 snort[5658]: Number of Nodes:   2052
    May 03 14:56:52 snort0 snort[5658]: Binder
    May 03 14:56:52 snort0 snort[5658]: --------------------------------------------------
    May 03 14:56:52 snort0 snort[5658]: nfq DAQ configured to inline.
...
```
    ...
    ================================================================================
    Installing:
     node_exporter   x86_64   0.14.0-1.el7.centos    prometheus-rpm_release   2.4 M
    ...
    Installed:
      node_exporter.x86_64 0:0.14.0-1.el7.centos                                    
...
```
    ...
    Installing:
     ...
     python2-idstools         noarch        0.6.0-1.el7           epel         89 k
     python34-idstools        noarch        0.6.0-1.el7           epel         91 k
    Installing for dependencies:
     python34                 x86_64        3.4.5-3.el7           epel         50 k
     python34-dateutil        noarch        1:2.4.2-3.el7         epel         82 k
     python34-libs            x86_64        3.4.5-3.el7           epel        6.7 M
     python34-six             noarch        1.10.0-1.el7          epel         32 k
    ...
    Installed:
      python-dateutil.noarch 0:1.5-7.el7      python2-idstools.noarch 0:0.6.0-1.el7 
      python34-idstools.noarch 0:0.6.0-1.el7 
    
    Dependency Installed:
      python34.x86_64 0:3.4.5-3.el7        python34-dateutil.noarch 1:2.4.2-3.el7  
      python34-libs.x86_64 0:3.4.5-3.el7   python34-six.noarch 0:1.10.0-1.el7      
...
```
    ...
    64 bytes from snort0 (192.168.17.30): icmp_seq=1 ttl=64 time=16.4 ms
...
```
    ...
    (Event)
    	sensor id: 0	event id: 1	event second: 1493823488	event microsecond: 849732
    ...
    Packet
    	sensor id: 0	event id: 1	event second: 1493823488
    	packet second: 1493823488	packet microsecond: 849732
    	linktype: 228	packet_length: 84
    [    0] 45 00 00 54 18 C0 00 00 40 01 BE 66 C0 A8 11 14  E..T....@..f....
    [   16] C0 A8 11 1E 00 00 D2 2C 19 D5 00 01 00 F0 09 59  .......,.......Y
    [   32] 00 00 00 00 3E E1 0C 00 00 00 00 00 10 11 12 13  ....>...........
...
```
    ...
    {"type": "event", "event": {"sensor-id": 0, "impact": 0, "destination-ip": "192.168.17.30", "priority": 0, "protocol": 1, "impact-flag": 0, "sport-itype": 0, "event-microsecond": 849732, "signature-revision": 1, "dport-icode": 0, "source-ip": "192.168.17.20", "classification-id": 0, "generator-id": 1, "vlan-id": 0, "pad2": 0, "mpls-label": 0, "event-id": 1, "blocked": 0, "signature-id": 3000001, "event-second": 1493823488}}
    {"type": "packet", "packet": {"sensor-id": 0, "data": "RQAAVBjAAABAAb5mwKgRFMCoER4AANIsGdUAAQDwCVkAAAAAPuEMAAAAAAAQERITFBUWFxgZGhscHR4fICEiIyQlJicoKSorLC0uLzAxMjM0NTY3", "event-id": 1, "packet-second": 1493823488, "event-second": 1493823488, "packet-microsecond": 849732, "length": 84, "linktype": 228}}
...
```
    ...
    14:58:08.849732 00:00:40:01:be:66 (oui Unknown) > 45:00:00:54:18:c0 (oui Unknown), ethertype Unknown (0xc0a8), length 84: 
...
```
    ...
    14:58:08.849732 IP monitor0 > snort0: ICMP echo reply, id 6613, seq 1, length 64
...
```
    ...
    job 1 at Wed May  3 14:59:00 2017
...
```
    ...
    {"type": "event", "event": {"protocol": 6, "signature-revision": 1, "vlan-id": 0, "impact": 0, "generator-id": 1, "source-ip": "192.168.17.20", "pad2": 0, "priority": 3, "sport-itype": 59996, "classification-id": 1, "signature-id": 3000003, "destination-ip": "192.168.17.30", "event-microsecond": 268317, "sensor-id": 0, "dport-icode": 80, "mpls-label": 0, "blocked": 0, "impact-flag": 0, "event-id": 2, "event-second": 1493823540}}
...
```
    ...
    15:00:38.484367 IP monitor0.60014 > snort0.http: Flags [S], seq 2930856475, win 29200, options [mss 1460,sackOK,TS val 158258 ecr 0,nop,wscale 6], length 0
    15:00:38.484850 IP snort0.http > monitor0.60014: Flags [R.], seq 0, ack 2930856476, win 0, length 0
...
```
    ...
    (Event)
    	sensor id: 0	event id: 1	event second: 1493823648	event microsecond: 494777
    	sig id: 3000003	gen id: 1	revision: 1	 classification: 1
    	priority: 3	ip source: 192.168.17.20	ip destination: 192.168.17.30
    	src port: 60016	dest port: 80	ip_proto: 6	impact_flag: 0	blocked: 0
    	mpls label: 0	vland id: 0	policy id: 0
    
    Packet
    	sensor id: 0	event id: 1	event second: 1493823648
    	packet second: 1493823648	packet microsecond: 494777
    	linktype: 228	packet_length: 138
    [    0] 45 00 00 8A 9E 89 40 00 40 06 F8 61 C0 A8 11 14  E.....@.@..a....
    [   16] C0 A8 11 1E EA 70 00 50 A8 9C 0F CB 00 60 02 2C  .....p.P.....`.,
    [   32] 80 18 01 C9 49 CC 00 00 01 01 08 0A 00 02 91 4D  ....I..........M
    [   48] 00 00 F6 A7 47 45 54 20 2F 73 6E 6F 72 74 2D 74  ....GET /snort-t
    ...
    (Event)
    	sensor id: 0	event id: 2	event second: 1493823658	event microsecond: 505243
    	sig id: 3000003	gen id: 1	revision: 1	 classification: 1
    	priority: 3	ip source: 192.168.17.20	ip destination: 192.168.17.30
    	src port: 60020	dest port: 80	ip_proto: 6	impact_flag: 0	blocked: 0
    	mpls label: 0	vland id: 0	policy id: 0
    
    Packet
    	sensor id: 0	event id: 2	event second: 1493823658
    	packet second: 1493823658	packet microsecond: 505243
    	linktype: 228	packet_length: 138
    [    0] 45 00 00 8A 7E F6 40 00 40 06 17 F5 C0 A8 11 14  E...~.@.@.......
    [   16] C0 A8 11 1E EA 74 00 50 EB 89 C6 94 28 4D 10 E2  .....t.P....(M..
    [   32] 80 18 01 C9 CB 37 00 00 01 01 08 0A 00 02 B8 68  .....7.........h
    [   48] 00 01 1D C2 47 45 54 20 2F 73 6E 6F 72 74 2D 74  ....GET /snort-t
    [   64] 65 73 74 2D 61 6C 65 72 74 20 48 54 54 50 2F 31  est-alert HTTP/1
    [   80] 2E 31 0D 0A 55 73 65 72 2D 41 67 65 6E 74 3A 20  .1..User-Agent: 
    [   96] 63 75 72 6C 2F 37 2E 32 39 2E 30 0D 0A 48 6F 73  curl/7.29.0..Hos
    [  112] 74 3A 20 73 6E 6F 72 74 30 0D 0A 41 63 63 65 70  t: snort0..Accep
...
```
    ...
    {"type": "event", "event": {"priority": 3, "dport-icode": 80, "protocol": 6, "vlan-id": 0, "signature-id": 3000003, "event-microsecond": 494777, "generator-id": 1, "signature-revision": 1, "sport-itype": 60016, "source-ip": "192.168.17.20", "blocked": 0, "classification-id": 1, "pad2": 0, "event-id": 1, "destination-ip": "192.168.17.30", "event-second": 1493823648, "sensor-id": 0, "impact": 0, "impact-flag": 0, "mpls-label": 0}}
    {"type": "event", "event": {"priority": 3, "dport-icode": 80, "protocol": 6, "vlan-id": 0, "signature-id": 3000003, "event-microsecond": 505243, "generator-id": 1, "signature-revision": 1, "sport-itype": 60020, "source-ip": "192.168.17.20", "blocked": 0, "classification-id": 1, "pad2": 0, "event-id": 2, "destination-ip": "192.168.17.30", "event-second": 1493823658, "sensor-id": 0, "impact": 0, "impact-flag": 0, "mpls-label": 0}}
...
```
    ...
    {"status":"success","data":{"resultType":"vector","result":[{"metric":{"blocked":"0","dport_icode":"80","generator_id":"1","instance":"snort0:9100","job":"node","signature_id":"3000003","source_ip":"192.168.17.20"},"value":[1493823970.28,"5.522765925925926"]}]}}
...
```
    ...
    job 1 at Wed May  3 15:08:00 2017
...
```
    ...
    05/03-15:08:00.254890 [**] [122:1:1] "PSNG_TCP_PORTSCAN" [**] [Priority: 0] {IP} 192.168.17.10 -> 192.168.17.30
...
```
    ...
    {"type": "event", "event": {"priority": 0, "impact-flag": 0, "event-second": 1493824080, "signature-id": 1, "event-id": 44, "pad2": 0, "generator-id": 122, "signature-revision": 1, "dport-icode": 0, "blocked": 0, "event-microsecond": 254824, "vlan-id": 0, "source-ip": "192.168.17.10", "destination-ip": "192.168.17.30", "sensor-id": 0, "protocol": 6, "mpls-label": 0, "classification-id": 0, "sport-itype": 0, "impact": 0}}
...
```
    ...
    ================================================================================
    Installing:
     tcpreplay          x86_64          4.2.1-1.el7             epel          304 k
    Installing for dependencies:
     tcpdump            x86_64          14:4.5.1-3.el7          base          387 k
    ...
    Public key for tcpreplay-4.2.1-1.el7.x86_64.rpm is not installed
    
    Installed:
      tcpreplay.x86_64 0:4.2.1-1.el7                                                
    ...
    warning: /var/cache/yum/x86_64/7/epel/packages/tcpreplay-4.2.1-1.el7.x86_64.rpm: Header V3 RSA/SHA256 Signature, key ID 352c64e5: NOKEY
    Importing GPG key 0x352C64E5:
     Userid     : "Fedora EPEL (7) <epel@fedoraproject.org>"
     Fingerprint: 91e9 7d7c 4a5e 96f1 7f3e 888f 6a2f aea2 352c 64e5
     Package    : epel-release-7-9.noarch (installed)
...
but the load on `snort0` caused by `attacker0` was sufficient for our snort test alerts from `monitor0` to be missed by `snort0`. Let's quickly check the count of the test alerts, the rate should be "WARNING" or "CRITICAL" if the increase of load on `snort0` was indeed sufficient:
...
```
    ...
    Package tcpreplay-4.2.1-1.el7.x86_64 already installed and latest version
...
```
    ...
    05/03-15:15:54.241409 [**] [1:3000003:1] "snort-test-alert" [**] [Classification: Not Suspicious Traffic] [Priority: 3] {TCP} 192.168.17.20:60450 -> 192.168.17.30:80
...
```
    ...
    Starting Nmap 6.40 ( http://nmap.org ) at 2017-05-03 15:16 UTC
    ...
    + Target Port:        80
    + Start Time:         2017-05-03 15:16:33 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:16:33 (GMT0) (0 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    ...
    ***Debug: sending command: /usr/bin/sudo /usr/bin/nmap -sX -p 80 snort0
    ...
    Starting Ncrack 0.4ALPHA ( http://ncrack.org ) at 2017-05-03 15:17 UTC
    ...
    Starting Nmap 6.40 ( http://nmap.org ) at 2017-05-03 15:17 UTC
    Nmap scan report for snort0 (192.168.17.30)
    ...
    | ssh-hostkey: 2048 5b:b2:16:02:76:fd:8e:3c:dc:e0:f3:df:31:3d:4b:e1 (RSA)
    |_256 2a:dd:72:1a:f5:01:be:03:cc:d2:3c:33:11:3b:77:f0 (ECDSA)
    ...
    TCP/IP fingerprint:
    OS:SCAN(V=6.40%E=4%D=5/3%OT=21%CT=1%CU=36254%PV=Y%DS=1%DC=D%G=Y%M=080027%TM
    OS:=5909F491%P=x86_64-redhat-linux-gnu)SEQ(SP=F2%GCD=1%ISR=103%TI=Z%II=I%TS
    OS:=A)SEQ(SP=F2%GCD=1%ISR=103%TI=Z%TS=A)OPS(O1=M5B4ST11NW6%O2=M5B4ST11NW6%O
    OS:3=M5B4NNT11NW6%O4=M5B4ST11NW6%O5=M5B4ST11NW6%O6=M5B4ST11)WIN(W1=7120%W2=
    OS:7120%W3=7120%W4=7120%W5=7120%W6=7120)ECN(R=Y%DF=Y%T=40%W=7210%O=M5B4NNSN
    ...
    No exact OS matches for host (If you know what OS is running on it, see http://nmap.org/submit/ ).
    TCP/IP fingerprint:
    OS:SCAN(V=6.40%E=4%D=5/3%OT=21%CT=1%CU=30305%PV=Y%DS=1%DC=D%G=Y%M=080027%TM
    OS:=5909F4A7%P=x86_64-redhat-linux-gnu)SEQ(SP=104%GCD=1%ISR=105%TI=Z%TS=A)S
    OS:EQ(SP=104%GCD=1%ISR=105%TI=Z%CI=I%TS=A)SEQ(SP=104%GCD=1%ISR=105%TI=Z%II=
    ...
    TRACEROUTE
    HOP RTT     ADDRESS
    1   0.49 ms snort0 (192.168.17.30)
    
    OS and Service detection performed. Please report any incorrect results at http://nmap.org/submit/ .
    Nmap done: 1 IP address (1 host up) scanned in 17.96 seconds
    
    Starting Nmap 6.40 ( http://nmap.org ) at 2017-05-03 15:18 UTC
    Nmap scan report for snort0 (192.168.17.30)
    ...
    No exact OS matches for host (If you know what OS is running on it, see http://nmap.org/submit/ ).
    TCP/IP fingerprint:
    OS:SCAN(V=6.40%E=4%D=5/3%OT=21%CT=1%CU=40963%PV=Y%DS=1%DC=D%G=Y%M=080027%TM
    OS:=5909F4C1%P=x86_64-redhat-linux-gnu)SEQ(SP=105%GCD=1%ISR=10D%TI=Z%TS=A)S
    OS:EQ(SP=105%GCD=1%ISR=10D%TI=Z%II=I%TS=A)OPS(O1=M5B4ST11NW6%O2=M5B4ST11NW6
    ...
    TRACEROUTE
    HOP RTT     ADDRESS
    1   0.52 ms snort0 (192.168.17.30)
    ...
    + Start Time:         2017-05-03 15:18:30 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:18:30 (GMT0) (0 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Start Time:         2017-05-03 15:18:34 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:18:34 (GMT0) (0 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Start Time:         2017-05-03 15:18:38 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:18:39 (GMT0) (1 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Start Time:         2017-05-03 15:18:43 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:18:43 (GMT0) (0 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Start Time:         2017-05-03 15:18:47 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:18:48 (GMT0) (1 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Start Time:         2017-05-03 15:18:52 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:18:52 (GMT0) (0 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Start Time:         2017-05-03 15:18:56 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:18:57 (GMT0) (1 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Start Time:         2017-05-03 15:19:01 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:19:01 (GMT0) (0 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Target Hostname:    snort0
    + Target Port:        80
    + Start Time:         2017-05-03 15:19:05 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:19:05 (GMT0) (0 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    - ***** RFIURL is not defined in nikto.conf--no RFI tests will run *****
    - ***** SSL support not available (see docs for SSL install) *****
    ...
    + Target Hostname:    snort0
    + Target Port:        80
    + Start Time:         2017-05-03 15:19:10 (GMT0)
    ---------------------------------------------------------------------------
    + Server: Apache/2.4.6 (CentOS)
    + 4197 items checked: 0 error(s) and 0 item(s) reported on remote host
    + End Time:           2017-05-03 15:19:10 (GMT0) (0 seconds)
    ---------------------------------------------------------------------------
    + 1 host(s) tested
    ........ 
    ...
    ***Debug: sending command: /usr/bin/sudo /usr/bin/nikto -config /etc/nikto/config -h snort0 -Plugins cgi -evasion B
    ...
    64 bytes from snort0 (192.168.17.30): icmp_seq=1 ttl=64 time=0.343 ms
    ...
    ***Debug: sending command: /usr/bin/ping -c 1 snort0
    ...
    apr_sockaddr_info_get() for %target%: Name or service not known (670002)
    [03/May/2017:15:19:45] ENGINE Listening for SIGHUP.
    [03/May/2017:15:19:45] ENGINE Listening for SIGTERM.
    [03/May/2017:15:19:45] ENGINE Listening for SIGUSR1.
    [03/May/2017:15:19:45] ENGINE Bus STARTING
    [03/May/2017:15:19:45] ENGINE Started monitor thread '_TimeoutMonitor'.
    [03/May/2017:15:19:45] ENGINE Serving on 127.0.0.1:8080
    [03/May/2017:15:19:45] ENGINE Bus STARTED
    [03/May/2017:15:27:58] ENGINE Caught signal SIGTERM.
    [03/May/2017:15:27:58] ENGINE Bus STOPPING
    [03/May/2017:15:27:58] ENGINE HTTP Server cherrypy._cpwsgi_server.CPWSGIServer(('127.0.0.1', 8080)) shut down
    [03/May/2017:15:27:58] ENGINE Stopped thread '_TimeoutMonitor'.
    [03/May/2017:15:27:58] ENGINE Bus STOPPED
    [03/May/2017:15:27:58] ENGINE Bus EXITING
    [03/May/2017:15:27:58] ENGINE Bus EXITED
    [03/May/2017:15:27:58] ENGINE Waiting for child threads to terminate...
...
```
    ...
    snort-3.0.0-0.232.a4.el7.centos.x86_64
    snort-extra-1.0.0-0.232.a4.el7.centos.x86_64
